# Кузница "Д.Гена"
Этот проект основан на шаблоне Start Bootstrap Agency и адаптирован для кузницы "Д.Гена".
...
Для подробной инструкции по локальному запуску сервера и клиента смотрите файл [LOCAL_SETUP.md](LOCAL_SETUP.md).
